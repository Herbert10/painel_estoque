                ...
                tr.innerHTML = `
                    ...
                    <td>
                        <input 
                            ...
                            data-url="${produto.produto_url || 'www.megatoon.org'}">
                    </td>
                `;
...
function enviarMensagem() {
    ...
    const urls = Array.from(checkboxes).map(cb => cb.dataset.url); // Captura as URLs dos produtos
    ...
    console.log("URLs selecionadas:", urls); // Log das URLs
    ...
    const data = {
        ...
        urls: urls // Inclui as URLs no corpo da requisição
    };
